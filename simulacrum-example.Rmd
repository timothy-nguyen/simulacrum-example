...
**Note**: Age is recorded at time of diagnosis. The same patient may appear multiple times if they have more than one tumour.
...
ggplot(data = charlson_total, aes(x = CHRL_TOT_27_03, y = pct,
  ...
  labs(x = "Total Charlson comorbidity score", y = "Percent",
       title = "Distribution of Charlson comorbidity score for tumour diagnosed patients")
```
